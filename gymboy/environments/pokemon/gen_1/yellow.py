...
class PokemonYellowFlatten(gym.Env):
    ...
    Args:
        rom_path (str | None):
            ...
            If ``None``, ``resources/roms/pokemon/gen_1/pokemon_yellow.gbc`` will be used
    ...
    def __init__(
        ...
        self.cartridge_title = "POKEMON YELLOW"
...
class PokemonYellowFullImage(gym.Env):
    """
    The Pokemon Yellow environment.
...
class PokemonYellowMinimalImage(gym.Env):
    """
    The Pokemon Yellow environment.
