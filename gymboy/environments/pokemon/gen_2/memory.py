...
def pokemon_ids(pyboy: PyBoy) -> np.ndarray:
    """
...
def levels(pyboy: PyBoy) -> np.ndarray:
    """
...
def hps(pyboy: PyBoy) -> np.ndarray:
    """
...
def max_hps(pyboy: PyBoy) -> np.ndarray:
    """
...
def exps(pyboy: PyBoy) -> np.ndarray:
    """
...
def moves(pyboy: PyBoy) -> np.ndarray:
    """
...
def pps(pyboy: PyBoy) -> np.ndarray:
    """
...
def max_pps(pyboy: PyBoy) -> np.ndarray:
    """
    ...
    """
    return np.array(
        [[MOVES_TO_MAX_PP[move] for move in pokemon] for pokemon in moves(pyboy)]
    )


def seen_pokemons(pyboy: PyBoy) -> int:
    """
