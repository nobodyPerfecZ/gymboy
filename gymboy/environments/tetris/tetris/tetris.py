...
class TetrisMinimalImage(gym.Env):
    """
    The Tetris environment.
    ...
    ## Observation Space
    The observation is an (18, 10) array representing a simplified view of the game screen.
