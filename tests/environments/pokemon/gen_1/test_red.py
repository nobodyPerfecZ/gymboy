...
class TestPokemonRedFullImage:
    """Tests the PokemonRedFullImage class."""

    env_id = "Pokemon-Red-full-image-v1"
    rom_path = "./resources/roms/pokemon/gen_1/pokemon_red.gb"
    init_state_path = (
        "./resources/tests/pokemon/gen_1/pokemon_red_after_second_order.state"
    )
    num_envs = 3
...
class TestPokemonRedMinimalImage:
    """Tests the PokemonRedMinimalImage class."""

    env_id = "Pokemon-Red-minimal-image-v1"
    rom_path = "./resources/roms/pokemon/gen_1/pokemon_red.gb"
    init_state_path = (
        "./resources/tests/pokemon/gen_1/pokemon_red_after_second_order.state"
    )
