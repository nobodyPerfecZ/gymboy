...
class TestPokemonYellow(unittest.TestCase):
    ...
    def test_get_reward(self):
        ...
        np.testing.assert_allclose(2.1958296496627168, reward)
    ...
    def test_get_exps(self):
        ...
        np.testing.assert_allclose([222, 0, 0, 0, 0, 0], exps)
    ...
    def test_get_events_reward(self):
        ...
        np.testing.assert_allclose(0.00274294670846395, events_reward)
