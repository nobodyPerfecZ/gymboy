...
class TestPokemonYellowFlatten(unittest.TestCase):
    ...
    def setUp(self):
        self.env = gymboy.make(
            env_id="Pokemon-Yellow-flatten-v1",
            init_state_path="./tests/resources/states/pokemon/gen_1/yellow/pokemon_yellow_first_pokemon.state",
        )
        self.env.reset()
    ...
    def test_get_reward(self):
        ...
        np.testing.assert_allclose(0.029162982996049906, self.env.get_reward())
    ...
    def test_vectorized_env(self):
        ...
        self.assertIsInstance(obs, np.ndarray)
        self.assertEqual((num_envs, 426), obs.shape)
...
class TestPokemonYellowImage(unittest.TestCase):
    """Tests the PokemonYellowImage class."""

    def setUp(self):
        self.env = gymboy.make(
            env_id="Pokemon-Yellow-image-v1",
            init_state_path="./tests/resources/states/pokemon/gen_1/yellow/pokemon_yellow_first_pokemon.state",
        )
        self.env.reset()
