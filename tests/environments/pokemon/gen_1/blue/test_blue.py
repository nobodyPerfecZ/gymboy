...
class TestPokemonBlueFlatten(unittest.TestCase):
    ...
    def setUp(self):
        self.env = gymboy.make(
            env_id="Pokemon-Blue-flatten-v1",
            init_state_path="./tests/resources/states/pokemon/gen_1/blue/pokemon_blue_first_pokemon.state",
        )
        self.env.reset()
...
class TestPokemonBlueImage(unittest.TestCase):
    """Tests the PokemonBlue class."""

    def setUp(self):
        self.env = gymboy.make(
            env_id="Pokemon-Blue-image-v1",
            init_state_path="./tests/resources/states/pokemon/gen_1/blue/pokemon_blue_first_pokemon.state",
        )
        self.env.reset()
