...
class TestPokemonSilverFlatten(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.init_state_path = "./tests/resources/states/pokemon/gen_2/silver/pokemon_silver_first_pokemon.state"
        self.num_envs = 3
    ...
    def test_get_reward(self):
        ...
        np.testing.assert_allclose(0.019301463823376174, self.env.get_reward())
    ...
    def test_vectorized_env(self):
        ...
        obs, reward, terminated, truncated, info = vectorized_env.step([0] * self.num_envs)
        self.assertIsInstance(obs, np.ndarray)
        self.assertEqual((self.num_envs, 426), obs.shape)
        ...
        obs, reward, terminated, truncated, info = vectorized_env.step([1] * self.num_envs)
        self.assertIsInstance(obs, np.ndarray)
        self.assertEqual((self.num_envs, 426), obs.shape)
        self.assertIsInstance(reward, np.ndarray)
        self.assertEqual((self.num_envs,), reward.shape)
...
class TestPokemonSilverImage(unittest.TestCase):
    """Tests the PokemonSilverImage class."""

    def setUp(self):
        self.env_id = "Pokemon-Silver-image-v1"
        self.init_state_path = "./tests/resources/states/pokemon/gen_2/silver/pokemon_silver_first_pokemon.state"
        self.num_envs = 3
        self.vectorization_mode = "sync"
