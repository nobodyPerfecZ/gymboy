...
class TestSuperMarioLand(unittest.TestCase):
    ...
    def setUp(self):
        self.env1 = gymboy.make("Super-Mario-Land-v1", render_mode=None)
        self.env2 = gymboy.make("Super-Mario-Land-v1", render_mode="human")
        self.env3 = gymboy.make("Super-Mario-Land-v1", render_mode="rgb_array")
