...
class TestSuperMarioLand2(unittest.TestCase):
    ...
    def setUp(self):
        self.env1 = gymboy.make("Super-Mario-Land-2-v1", render_mode=None)
        self.env2 = gymboy.make("Super-Mario-Land-2-v1", render_mode="human")
        self.env3 = gymboy.make("Super-Mario-Land-2-v1", render_mode="rgb_array")
